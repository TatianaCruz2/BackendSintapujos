...
//             atributes: ['aprendiz_nombre', 'aprendiz_apellido', 'aprendiz_tipoDocumento', 'aprendiz_numeroDocumento', 'aprendiz_telefono', 'aprendiz_fechaNacimiento', 'aprendiz_correoElectronico', 'aprendiz_contraseñaLogin','aprendiz_numeroFicha'],
//         });
//         res.json(aprendices);
//     } catch (error) {
